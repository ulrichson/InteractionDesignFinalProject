...
/* Metadata for the video. The title, level, score, and description can be modified before the video starts being uploaded. */
...
/* Retrieves the video ticket for the video with the given just a video ID. The delegate will be pass the ticket once the download finishes. */

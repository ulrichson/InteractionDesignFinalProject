...
@property (readonly, nonatomic, copy) NSString * defaultMessage;
...
typedef enum
{
    ...
    // Belongs after all the video processing stuff
    KC_VIDEO_NO_VIDEO,                          // Happens when we have 0 clips
...
@property (nonatomic, assign) BOOL          frameSuccessfullyWritten;

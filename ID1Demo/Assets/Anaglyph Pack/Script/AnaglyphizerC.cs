...
public class AnaglyphizerC : MonoBehaviour
{
	...
	void Start ()
	{
		...
		if (anaglyphMat == null && !useSideBySide) {
			Debug.LogError ("No Material Found Please Drag The material in the appropriate Field or check Side by side.");
			this.enabled = false;
			return;
		}
...
//		rightEye.camera.depth = camera.depth -1;
	...
	private void DrawQuad ()
	{
		...
		GL.Vertex3 (0.0f, 0.0f, zvalue);
		GL.TexCoord2 (1.0f, 0.0f);
		GL.Vertex3 (1.0f, 0.0f, zvalue);
		GL.TexCoord2 (1.0f, 1.0f);
		GL.Vertex3 (1.0f, 1.0f, zvalue);
		GL.TexCoord2 (0.0f, 1.0f);
		GL.Vertex3 (0.0f, 1.0f, zvalue);
		GL.End ();
	}
